...
#define FONT_MENU_TITLE_SIZE    0.083f
#define FONT_MENU_H1_SIZE       0.0416f
#define FONT_MENU_H2_SIZE       0.03125f
#define FONT_MENU_TEXT_SIZE     0.015625f

extern libVec2i screenSize;
extern libVec2i gameScreen;
