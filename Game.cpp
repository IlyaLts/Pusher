...
bool Game::Init()
{
    LIB_CHECK(engine->Get(tex_moveBlocked, DATA_PACK "Textures/MoveBlocked.tga"));
    LIB_CHECK(engine->Get(tex_movePath, DATA_PACK "Textures/MovePath.tga"));
    LIB_CHECK(engine->Get(tex_move, DATA_PACK "Textures/Move.tga"));
    LIB_CHECK(engine->Get(tex_moveBox, DATA_PACK "Textures/MoveBox.tga"));
    LIB_CHECK(engine->Get(tex_box, DATA_PACK "Textures/Box.tga"));
    LIB_CHECK(engine->Get(tex_endpoint, DATA_PACK "Textures/Endpoint.tga"));
    LIB_CHECK(engine->Get(tex_wall, DATA_PACK "Textures/Wall.tga"));
    LIB_CHECK(engine->Get(tex_floor, DATA_PACK "Textures/Floor.tga"));
    LIB_CHECK(engine->Get(spr_robot, DATA_PACK "Textures/Robot/Robot.tga"));
    LIB_CHECK(engine->Get(snd_move, DATA_PACK "Sounds/Move.wav"));
    LIB_CHECK(engine->Get(snd_levelComplete, DATA_PACK "Sounds/LevelComplete.wav"));

    engine->Get(mesh_moveBlocked);
    engine->Get(mesh_movePath);
    engine->Get(mesh_move);
    engine->Get(mesh_moveBox);
    engine->Get(mesh_box);
    engine->Get(mesh_endpoint);
    engine->Get(mesh_wall);
    engine->Get(mesh_floor);
...
void Game::Draw()
{
    ...
    engine->Draw(mesh_floor, tex_floor, true);
    engine->Draw(mesh_wall, tex_wall, true);
    engine->Draw(mesh_endpoint, tex_endpoint, true);
    engine->Draw(mesh_moveBox, tex_moveBox, true);
    engine->Draw(mesh_movePath, tex_movePath, true);
    engine->Draw(mesh_moveBlocked, tex_moveBlocked, true);
    engine->Draw(mesh_move, tex_move, true);
    engine->Draw(mesh_box, tex_box, true);
}
